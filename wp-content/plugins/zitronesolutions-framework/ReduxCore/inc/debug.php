    ...
    if ( ! class_exists( 'ReduxDebugObject' ) ) {
        ...
        class ReduxDebugObject {
            ...
            public function render() {
                ...
                echo '<h3>' . __( 'Options Object', 'zitronesolutions' ) . '</h3>';
                ...
                echo '<a href="#" id="consolePrintObject" class="button">' . __( 'Show Object in Javascript Console Object', 'zitronesolutions' ) . '</a>';
            ...
            public function render_tab() {
                ...
                echo '<a href="javascript:void(0);" id="dev_mode_default_section_group_li_a" class="redux-group-tab-link-a custom-tab" data-rel="dev_mode_default">' . $icon . ' <span class="group_title">' . __( 'Options Object', 'zitronesolutions' ) . '</span></a>';
                echo '</li>';
            }
            ...
            public function add_submenu() {
                add_theme_page(
                    ...
                    __( 'Options Object', 'zitronesolutions' ),
                    __( 'Options Object', 'zitronesolutions' ),
