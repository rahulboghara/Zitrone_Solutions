        ...
        class ReduxFramework_select {
            ...
            function render() {
                ...
                if ( ! empty( $this->field['options'] ) ) {
                    ...
                    $placeholder = ( isset( $this->field['placeholder'] ) ) ? esc_attr( $this->field['placeholder'] ) : __( 'Select an item', 'zitronesolutions' );
                    ...
                    echo '<strong>' . __( 'No items of this type were found.', 'zitronesolutions' ) . '</strong>';
                }
            } //function
