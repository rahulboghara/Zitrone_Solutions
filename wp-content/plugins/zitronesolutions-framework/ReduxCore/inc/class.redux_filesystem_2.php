        ...
        class Redux_Filesystem {
            ...
            public function ftp_form() {
                if ( isset( $this->ftp_form ) && ! empty( $this->ftp_form ) ) {
                    ...
                    echo __( 'Unable to create a required directory. Please ensure that', 'zitronesolutions' );
                    echo ' <code>' . Redux_Helpers::cleanFilePath( trailingslashit( WP_CONTENT_DIR ) ) . '/uploads/</code> ';
                    echo __( 'has the proper read/write permissions or enter your FTP information below.', 'zitronesolutions' );
