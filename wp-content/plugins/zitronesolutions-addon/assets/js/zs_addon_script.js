jQuery(document).ready(function($) {
  ...
  $(".zs-animated, .portfolio-item, .play-video, .toggle-map").inViewport(function(px) {
    if (px) $(this).addClass("zs-animate");
  });
...
$('.countdown').each(function (index, value){
 ...
 var count_date = count_year + '/' + count_month + '/' + count_day;
  ...
  jQuery(".zs_pie_chart .zs_chart").each(function (index, value){
    ...
    var chart = window.chart = jQuery("zs_pie_chart .zs_chart").data("easyPieChart");
  });
...
jQuery(window).load(function() {
 ...
 ------------------------------------------------------------------------*/
   ...
   jQuery('.zs-alertbox .ab-close').on('click', function(e) {
     e.preventDefault();
     jQuery(this).closest('.zs-alertbox').hide(200);
   });
