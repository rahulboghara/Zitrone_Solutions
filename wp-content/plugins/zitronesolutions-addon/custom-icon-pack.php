...
add_action( 'vc_after_init', 'zs_custom_icon_pack' );
add_action( 'vc_enqueue_font_icon_element', 'zs_custom_icon_pack_enqueue' );

add_action( 'vc_backend_editor_enqueue_js_css', 'zs_vc_iconpicker_editor_jscss' );
add_action( 'vc_frontend_editor_enqueue_js_css', 'zs_vc_iconpicker_editor_jscss' );

add_filter( 'vc_iconpicker-type-material', 'zs_custom_icon_pack_list_material' );


function zs_custom_icon_pack() {
	...
	$attributes = array(
		'type'        => 'iconpicker',
		'heading'     => __('Icon', 'zitronesolutions' ),
...
function zs_custom_icon_pack_enqueue( $font ) {
	switch( $font ) {
		case "materialicons":
...
function zs_vc_iconpicker_editor_jscss() {
	wp_enqueue_style( 'material-design-iconic-font' );
}


function zs_custom_icon_pack_list_material( $icons ) {
