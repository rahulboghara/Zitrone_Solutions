...
if (!class_exists('tek_reviewcarousel')) {
    class tek_reviewcarousel extends ZITRONESOLUTIONS_ADDON_CLASS
    {
        function __construct() {
            add_action('init', array($this, 'zs_reviewcarousel_init'));
            add_shortcode('tek_reviewcarousel', array($this, 'zs_reviewcarousel_container'));
            add_shortcode('tek_reviewcarousel_single', array($this, 'zs_reviewcarousel_single'));
        }
        // Element configuration in admin
        function zs_reviewcarousel_init() {
            // Container element configuration
            if (function_exists('vc_map')) {
                vc_map(array(
                    "name" => esc_html__("Reviews Carousel", "zitronesolutions"),
                    "description" => esc_html__("List all your client reviews in a carousel.", "zitronesolutions"),
                ...
                vc_map(array(
                    "name" => esc_html__("Review item", "zitronesolutions"),
        ...
        public function zs_reviewcarousel_container($atts, $content = null) {
            extract(shortcode_atts(array(
                ...
                $zs_rwpunique_id = "zs-rwc-".uniqid();

                $output .= '
                <div class="review-carousel rc-parent '.$zs_rwpunique_id.' '.$rwp_extra_class.'">
                    <div class="rc-content">'.do_shortcode($content).'</div>
                </div>';

                $output .= '<script type="text/javascript">
          				jQuery(document).ready(function($){
                    if ($(".review-carousel.'.$zs_rwpunique_id.' .rc-content").length) {
                      $(".review-carousel.'.$zs_rwpunique_id.' .rc-content").owlCarousel({
                  	  itemsDesktop: [1199,3],
                  	  itemsTablet: [768,2],
                  	  itemsMobile: [479,1],
                        navigation: false,
        ...
        public function zs_reviewcarousel_single($atts, $content = null) {
            extract(shortcode_atts(array(
                'rw_author_name' => '',
