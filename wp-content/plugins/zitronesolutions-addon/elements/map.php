<?php
if (!class_exists('ZS_ELEM_MAP')) {
    class ZS_ELEM_MAP extends ZITRONESOLUTIONS_ADDON_CLASS {
        function __construct() {
            add_action( 'init', array($this, 'zs_map_init') );
            add_shortcode( 'tek_map', array($this, 'zs_map_shrt') );
        }

        // Element configuration in admin
        function zs_map_init() {

            if (function_exists('vc_map')) {
                vc_map(array(
                    "name" => esc_html__("Google Map", "zitronesolutions"),
                    "description" => esc_html__("Custom Google Map", "zitronesolutions"),
                    "base" => "tek_map",
                    "class" => "",
                    ...
                    "params" => array(
                        ...
                        array(
          								"type"			=>	"textfield",
          								"class"			=>	"",
          								"heading"		=>	esc_html__("Map name", "zitronesolutions"),
          								"param_name"	=>	"map_name",
          								"value"			=>	"",
          								"description"	=>	esc_html__("Insert a unique map name.", "zitronesolutions"),
          								"save_always"	=>	true,
          							),
                        ...
                        array(
                            "type"          => "textfield",
                            "class"         => "",
                            "heading"       => esc_html__("Location latitude", "zitronesolutions"),
                            "param_name"    => "map_latitude",
                            "value"         => "",
                            "description"   => esc_html__("Enter location latitude.", "zitronesolutions")
                        ),

                        array(
                            "type"          => "textfield",
                            "class"         => "",
                            "heading"       => esc_html__("Location longitude", "zitronesolutions"),
                            "param_name"    => "map_longitude",
                            "value"         => "",
                            "description"   => esc_html__("Enter location longitude.", "zitronesolutions")
                        ),

                        array(
                            "type"          => "dropdown",
                            "class"         => "",
                            "heading"       => esc_html__("Map zoom", "zitronesolutions"),
                            "param_name"    => "map_zoom",
                            "value"     =>  array(
                                "10 - City" => "10",
                                "11" => "11",
                            ...
                            "description"   => esc_html__("Enter map zoom (default 14).", "zitronesolutions")
                        ),

                        array(
            								"type"			=>	"dropdown",
            								"class"			=>	"",
            								"heading"		=>	esc_html__("Map style", "zitronesolutions"),
            								"param_name"	=>	"map_style",
            								"value"			=>	array(
                                esc_html__( 'Grayscale', 'zitronesolutions' ) 			=> 'gmap_style_grayscale',
            										esc_html__( 'Google preset colors', 'zitronesolutions' )	=> 'gmap_style_normal',
            									),
            								"description"	=>	esc_html__("Choose map style.", "zitronesolutions"),
            								"save_always"	=>	true,
          							),

                        array(
                            "type"          => "attach_image",
                            "heading"       => esc_html__("Map marker icon", "zitronesolutions"),
                            "param_name"    => "map_icon",
                            "description"   => esc_html__("Upload Map marker icon.", "zitronesolutions")
                        ),

                        array(
                            "type"			=>	"dropdown",
                            "class"			=>	"",
                            "heading"		=>	esc_html__("Display toggle on/off button","zitronesolutions"),
                            ...
                            "save_always" => true,
                            "description"	=>	esc_html__("The button will show/hide the map marker.", "zitronesolutions"),
                        ),

                        array(
                            "type"          => "textfield",
                            "class"         => "",
                            "heading"       => esc_html__("Map button text", "zitronesolutions"),
                            ...
                            "description"   => esc_html__("Enter the text displayed on the button.", "zitronesolutions")
                        ),

                        array(
                            "type"          => "textfield",
                            "class"         => "",
                            "heading"       => esc_html__("Map height", "zitronesolutions"),
                            ...
                            "description"   => esc_html__("Enter map height in pixels. Default is 400px.", "zitronesolutions")
                        ),
        ...
        public function zs_map_shrt($atts, $content = null) {
            ...
            $output .= '<div class="contact-map-container '.$map_toggle.'" '.(!empty($map_height) ? 'style="height: '.$map_height.';"' : '').'>';
                ...
                $output .= '<div id="'.$id.'" class="zs_map" '.(!empty($map_height) ? 'style="height: '.$map_height.';"' : '').'></div>
            </div>';
