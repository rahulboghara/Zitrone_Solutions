...
if (!class_exists('tek_masonrygallery_elem')) {
    class tek_masonrygallery_elem extends ZITRONESOLUTIONS_ADDON_CLASS
    {
        function __construct() {
            add_action('init', array( $this, 'zs_featured_init' ));
            add_shortcode('tek_masonrygallery_elem', array( $this, 'zs_masonrygallery_container' ));
            add_shortcode('tek_masonrygallery_elem_single', array( $this, 'zs_masonrygallery_single' ));
        ...
        function zs_featured_init() {
            ...
            if (function_exists('vc_map')) {
                vc_map(array(
                    "name" => esc_html__("Masonry Gallery", "zitronesolutions"),
                    "description" => esc_html__("Display a gallery with masonry effect.", "zitronesolutions"),
                ...
                vc_map(array(
                    "name" => esc_html__("Gallery single image", "zitronesolutions"),
        ...
        public function zs_masonrygallery_container($atts, $content = null) {
        ...
        public function zs_masonrygallery_single($atts, $content = null) {
