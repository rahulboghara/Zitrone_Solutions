...
if (!class_exists('tek_featured_elem')) {
    class tek_featured_elem extends ZITRONESOLUTIONS_ADDON_CLASS
    {
        function __construct() {
            add_action('init', array($this, 'zs_featured_init'));
            add_shortcode('tek_featured_elem', array($this, 'zs_featured_container'));
            add_shortcode('tek_featured_elem_single', array($this, 'zs_featured_single'));
        }
        // Element configuration in admin
        function zs_featured_init() {
            // Container element configuration
            if (function_exists('vc_map')) {
                vc_map(array(
                    "name" => esc_html__("Featured content", "zitronesolutions"),
                    "description" => esc_html__("Advanced featured content with smooth animations.", "zitronesolutions"),
                ...
                vc_map(array(
                    "name" => esc_html__("Featured item", "zitronesolutions"),
                    ...
                    "params" => array(
                        array(
                            ...
                            "admin_label" => true,
                            "value" => "",
                            "description" => esc_html__("Enter item title here.", "zitronesolutions")
                        ),
                        ...
                        array(
                            ...
                            "value" => "",
                            "description" => esc_html__("Enter item description here.", "zitronesolutions")
                        ),
                        ...
                        array(
                            "type" =>	"dropdown",
                            "class"	=>	"",
                            "heading" =>	esc_html__("Active element","zitronesolutions"),
        ...
        public function zs_featured_container($atts, $content = null) {
        ...
        public function zs_featured_single($atts, $content = null) {
            extract(shortcode_atts(array(
                'featured_title'            => '',
