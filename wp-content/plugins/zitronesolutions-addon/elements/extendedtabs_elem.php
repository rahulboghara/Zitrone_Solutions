...
if (!class_exists('tek_extended_tabs')) {
    class tek_extended_tabs extends ZITRONESOLUTIONS_ADDON_CLASS {
		function __construct() {
			add_action('admin_init', array($this, 'zs_extended_tabs_init'));
			add_shortcode('tek_extended_tabs', array($this, 'zs_extended_tabs_container'));
			add_shortcode('tek_extended_tabs_single', array( $this, 'zs_extended_tabs_single'));
		}

      /* VC Elements render in admin */
		function zs_extended_tabs_init() {
			if (function_exists('vc_map')) {
				vc_map(array(
					"name" => esc_html__("Extended tabs", "zitronesolutions"),
					"description" => __("Vertical tabs with extended features.", "zitronesolutions"),
					...
					"params" => array(
						array(
							"type" => "dropdown",
							"class" => "",
							"heading" => esc_html__("Tabs alignment","zitronesolutions"),
							...
							"save_always" => true,
							"description" => esc_html__("Select tabs image alignment.", "zitronesolutions"),
						),
				...
				vc_map(array(
					"name" => esc_html__("Tab", "zitronesolutions"),
					...
					"params" => array(
						array(
							"type" => "textfield",
							"heading" => esc_html__("Tab Title", "zitronesolutions"),
							"param_name" => "services_title",
							"holder" => "tab_title",
							"value" => "",
							"description" => esc_html__("Enter tab title / tab anchor here.", "zitronesolutions")
						),

						array(
							"type" => "exploded_textarea",
							"heading" => esc_html__("Tab Content", "zitronesolutions"),
							"param_name" => "services_content",
							"value" => "",
							"description" => esc_html__("Content as list (Enter one feature per line)", "zitronesolutions")
						),
						...
						array(
							"type" => "attach_image",
							"heading" => esc_html__("Tab Image", "zitronesolutions"),
							"param_name" => "services_image",
							"value" => "",
							"description" => esc_html__("You can display one image per tab.", "zitronesolutions"),
						),
					)
				));
			}
		...
		public function zs_extended_tabs_container($atts, $content = null) {
		...
		public function zs_extended_tabs_single($atts, $content = null) {
			extract(shortcode_atts(array(
				'services_title' => '',
				'services_content' => '',
				'icon_type' => '',
      ...
      $service_title_trim .= "zs-extendtabs-".uniqid();
