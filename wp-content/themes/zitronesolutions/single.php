...
<div class="col-xs-12 col-sm-12 col-md-9 col-lg-9">
      ...
      <div <?php post_class(); ?> id="post-<?php the_ID(); ?>">
         <div class="blog-single-content">
            ...
            <div class="meta-content">
               ...
               <?php previous_post_link('%link', __('Previous', 'zitronesolutions')); ?>
               <?php next_post_link('%link', __('Next', 'zitronesolutions')); ?>
               </div>
            </div>
         </div>
      </div>
   ...
   <div id="post-not-found" <?php post_class() ?>>
      <h1 class="entry-title"><?php esc_html_e('Error 404 - Not Found', 'zitronesolutions')   ?></h1>
      <div class="entry-content">
         <p><?php esc_html_e("Sorry, but you are looking for something that isn't here.", "zitronesolutions")   ?></p>
      </div>
   </div>
   <?php endif; ?>
</div>
