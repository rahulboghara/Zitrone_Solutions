 ...
 */
 ...
 class zs_socials extends WP_Widget
 {
     function __construct()
     {
         $widget_ops = array(
             'classname' => 'zs-socials',
             'description' => esc_html__('List your social media links.', 'zitronesolutions')
         );

         $control_ops = array( 'id_base' => 'zs-socials' );
         WP_Widget::__construct( 'zs-socials', 'Social icons', $widget_ops, $control_ops );
     ...
     function register_zs_socials() {
          register_widget( 'zs_socials' );
     }
     add_action( 'widgets_init', 'register_zs_socials' );
