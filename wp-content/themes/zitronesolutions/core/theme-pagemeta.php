...
// Adds meta boxes to the main column on the Page edit screens.
	function themetek_add_meta_box() {
		...
		foreach ( $screens as $screen ) {
			...
			add_meta_box(
				'themetek_pagetitle',
				esc_html__( 'Page title & subtitle:', 'zitronesolutions' ), 'themetek_meta_box_pagetitle', $screen );

			// Page settings
			add_meta_box(
				'themetek_pagesettings',
				esc_html__( 'Page settings:', 'zitronesolutions' ), 'themetek_meta_box_pagesettings', $screen );
		}

			// Portfolio home page item size
			add_meta_box(
				'themetek_portfoliosize',
			esc_html__( 'Grid item size:', 'zitronesolutions' ), 'themetek_meta_box_portfolio', 'portfolio', 'side', 'default' );

			// Single portfolio page Templates
			add_meta_box(
				'themetek_portfolio_templates',
			esc_html__( 'Single page template', 'zitronesolutions' ), 'themetek_meta_box_portfolio_templates', 'portfolio', 'side', 'default');
	...
	function themetek_meta_box_pagetitle($post) {
		...
		echo '<div class="zs_meta_block_prim meta_block_top">';
			echo '<label for="page_showhide_title">';
				esc_html_e( 'Hide page title', 'zitronesolutions' );
			echo '</label>';
			...
			echo '<span class="zs-meta-desc">';
				esc_html_e( 'If checked, title will be hidden.', 'zitronesolutions' );
			echo '</span>';
		echo '</div>';
		// Page subtitle text
		echo '<div class="zs_meta_block_prim">';
			echo '<label for="page_subtitle">';
				esc_html_e( 'Page subtitle', 'zitronesolutions' );
			echo '</label>';
			echo '<input type="text" class="page_subtitle_box" id="page_subtitle" name="page_subtitle" value="' . esc_attr( $themetek_page_subtitle ) . '"/>';
			echo '<span class="zs-meta-desc">';
				esc_html_e( 'Write the section subtitle. Displayed under the main page title.', 'zitronesolutions' );
			echo '</span>';
		echo '</div>';
		// Page title and subtitle text color
		echo '<div class="zs_meta_block_prim meta_block_bottom">';
			echo '<label for="page_title_color">';
				esc_html_e( 'Title and subtitle color', 'zitronesolutions' );
			echo '</label>';
			...
			echo '<span class="zs-meta-desc">';
				esc_html_e( 'Specify the page title and subtitle color. Eg. #FFFFFF', 'zitronesolutions' );
			echo '</span>';
		echo '</div>';
	}
	...
	function themetek_meta_box_pagesettings($post) {
		...
		echo '<div class="zs_meta_block_prim meta_block_top">';
			echo '<label for="page_overlay">';
				esc_html_e( 'Overlay', 'zitronesolutions' );
			echo '</label>';
			...
			echo '<span class="zs-meta-desc">';
				esc_html_e( 'If checked, an overlay having the main theme color will be applied.', 'zitronesolutions' );
			echo '</span>';
		echo '</div>';
		// Section full width
		echo '<div class="zs_meta_block_prim meta_block">';
			echo '<label for="page_layout">';
				esc_html_e( 'Full width', 'zitronesolutions' );
			echo '</label>';
			$page_layout_checked = '';
