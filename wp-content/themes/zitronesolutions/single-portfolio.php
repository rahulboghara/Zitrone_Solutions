...
<?php
	...
	$zitronesolutions_page_portfolio_styles = isset( $values['page_portfolio_style'] ) ? esc_attr( $values['page_portfolio_style'][0] ) :'';
?>
<section id="single-page" class="section <?php echo esc_attr($post->post_name);?>">
    <div class="portfolio-content">


  		<?php if($zitronesolutions_page_portfolio_styles == 'single-full'): ?>
        ...
        <div class="container">
  		...
  		<?php elseif ($zitronesolutions_page_portfolio_styles == 'single-side'): ?>
        ...
        <div class="container">
  		...
  		<?php elseif ($zitronesolutions_page_portfolio_styles == 'gallery-full'): ?>
        ...
        <div class="container">
  		...
  		<?php elseif ($zitronesolutions_page_portfolio_styles == 'gallery-side'): ?>
        ...
        <div class="container">
  	    ...
  	    <?php elseif ($zitronesolutions_page_portfolio_styles == 'gallery-list'): ?>
              ...
              <div class="container">
                 <div class="port-nav-prev col-xs-6 col-sm-6 col-md-6 col-lg-6">
      				<?php
      					...
      					if(!empty($prev_post)) {
      						echo '<a class="port-prev tt_button" href="' . esc_url(get_permalink($prev_post->ID)) . '" title="' . esc_html($prev_post->post_title) . '"><i class="fa fa-angle-left"></i> ' . esc_html__("Prev", "zitronesolutions") . '</a>';
      					}
      				?>
      			</div>
      			<div class="port-nav-next col-xs-6 col-sm-6 col-md-6 col-lg-6">
      				<?php $next_post = get_adjacent_post(false, '', false);
      					if(!empty($next_post)) {
      						echo '<a class="port-next tt_button" href="' . esc_url(get_permalink($next_post->ID)) . '" title="' . esc_html($next_post->post_title) . '">' . esc_html__("Next", "zitronesolutions") . ' <i class="fa fa-angle-right"></i></a>';
      					}
      				?>
      			</div>
      		</div>
